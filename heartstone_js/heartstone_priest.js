    ...
    .done(function(result) {
        let pick =function (result) {
            if (result.playerClass == "PRIEST" || result.playerClass =="NEUTRAL") {
                return result
            }
        }
...
function freeCard(argument) {
    ...
    .done(function(result) {
        let pick =function (result) {
            if (result.rarity == "FREE" && (result.playerClass == "PRIEST" || result.playerClass =="NEUTRAL")) {
                return result
            }
        }
        let temp = result.filter(pick)
...
function commonCard(argument) {
    ...
    .done(function(result) {
        let pick =function (result) {
            if (result.rarity == "COMMON" && (result.playerClass == "PRIEST" || result.playerClass =="NEUTRAL")) {
                return result
            }
        }
        let temp = result.filter(pick)
...
function rareCard(argument) {
    ...
    .done(function(result) {
        let pick =function (result) {
            if (result.rarity == "RARE" && (result.playerClass == "PRIEST" || result.playerClass =="NEUTRAL")) {
                return result
            }
        }
        let temp = result.filter(pick)
...
function epicCard(argument) {
    ...
    .done(function(result) {
        let pick =function (result) {
            if (result.rarity == "EPIC" && (result.playerClass == "PRIEST" || result.playerClass =="NEUTRAL")) {
                return result
            }
        }
        let temp = result.filter(pick)
...
function legendaryCard(argument) {
    ...
    .done(function(result) {
        let pick =function (result) {
            if (result.rarity == "LEGENDARY" && (result.playerClass == "PRIEST" || result.playerClass =="NEUTRAL")) {
                return result
            }
        }
        let temp = result.filter(pick)
...
function zeroCostcard(argument) {
    ...
    .done(function(result) {
        let pick =function (result) {
            if (result.cost == 0 && (result.playerClass == "PRIEST" || result.playerClass =="NEUTRAL")) {
                return result
            }
        }
        let temp = result.filter(pick)
...
function oneCostcard(argument) {
    ...
    .done(function(result) {
        let pick =function (result) {
            if (result.cost == 1 && (result.playerClass == "PRIEST" || result.playerClass =="NEUTRAL")) {
                return result
            }
        }
        let temp = result.filter(pick)
...
function twoCostcard(argument) {
    ...
    .done(function(result) {
        let pick =function (result) {
            if (result.cost == 2 && (result.playerClass == "PRIEST" || result.playerClass =="NEUTRAL")) {
                return result
            }
        }
        let temp = result.filter(pick)
...
function threeCostcard(argument) {
    ...
    .done(function(result) {
        let pick =function (result) {
            if (result.cost == 3 && (result.playerClass == "PRIEST" || result.playerClass =="NEUTRAL")) {
                return result
            }
        }
        let temp = result.filter(pick)
...
function fourCostcard(argument) {
    ...
    .done(function(result) {
        let pick =function (result) {
            if (result.cost == 4 && (result.playerClass == "PRIEST" || result.playerClass =="NEUTRAL")) {
                return result
            }
        }
        let temp = result.filter(pick)
...
function fiveCostcard(argument) {
    ...
    .done(function(result) {
        let pick =function (result) {
            if (result.cost == 5 && (result.playerClass == "PRIEST" || result.playerClass =="NEUTRAL")) {
                return result
            }
        }
        let temp = result.filter(pick)
...
function sixCostcard(argument) {
    ...
    .done(function(result) {
        let pick =function (result) {
            if (result.cost == 6 && (result.playerClass == "PRIEST" || result.playerClass =="NEUTRAL")) {
                return result
            }
        }
        let temp = result.filter(pick)
...
function sevenCostcard(argument) {
    ...
    .done(function(result) {
        let pick =function (result) {
            if (+result.cost >= 7 && (result.playerClass == "PRIEST" || result.playerClass =="NEUTRAL")) {
                return result
            }
        }
        let temp = result.filter(pick)
